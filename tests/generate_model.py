...
if __name__ == "__main__":
    ...
    '''
    given a sample from the train dataset, distance should be = 0 and the resulted tensor should be ('Biserica_evanghelică_din_Cluj-Napoca') 
    '''
    print(test_prediction("datasets/test_images/Biserica_evanghelică_din_Cluj-Napoca/Biserica evanghelică din Cluj-Napoca_18.jpeg", save_path, test_file))
